...
export default function Contact({ lang }: { lang: TSupportedLanguages }) {
  const content = {
    tagline: {
  ...
  return (
    <LSection id="contact" className="flex flex-col justify-center items-center px-4" title="Contact">
