    ...
    <PageSection title={content.title[lang]}>
      <div className="max-w-4xl">
        ...
        <div className="bg-white/10 rounded-lg mb-16 p-12">
          <p className="mb-4">{content.iam[lang]}</p>
          <p className="mb-8">{content.iam2[lang]}</p>
          {/* <p className='mb-4'>{content.iam2[lang]}</p>
          <p className='mb-8'>{content.iam3[lang]}</p> */}
          <Title level="h4" titleClassName="text-2xl my-4">
            {content.journeyH4[lang]}
          </Title>
          <p className="mb-4">{content.journeyContent.p1[lang]}</p>
          <p>{content.journeyContent.p2[lang]}</p>
        </div>
