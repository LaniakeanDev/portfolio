...
export default function Hero({ lang }: ILang) {
  ...
  return (
    <PageSection id="top" className="min-h-[80vh] pt-32!">
      <div className="flex flex-row gap-4 xs:gap-8 items-center mb-16">
      ...
      <p className="text-2xl sm:text-3xl mb-16 text-center w-[90vw] max-w-xl!">{content.tagline[lang]}</p>
